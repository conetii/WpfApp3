...
![Шаблон кнопки](report-images/lab07/button-template.gif)

Видео: кнопки в обычном состоянии, при наведении и при нажатии.

![Смена темы](report-images/lab07/theme-switch.jpg)

Снимок: то же окно в светлой теме.
...
Снимок: окно после переключения на английский язык.
